...
import { IUser, LoginResponse, ProfileResponse, SignupResponse } from 'src/app/core/interfaces/user';
...
export class AuthService {
  ...
  editProfile(user_id: number, { firstName, lastName, email, phone, address }: 
    { firstName: string, lastName: string, email: string, phone: string, address: any }): Observable<ProfileResponse> {
